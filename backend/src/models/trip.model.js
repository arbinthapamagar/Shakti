...
const tripSchema = new mongoose.Schema(
  {
    ...
    // ─── Pricing ──────────────────────────────────────
    offeredPrice: { type: Number, required: true }, // rider offered
    finalPrice:   { type: Number, default: null },  // accepted bid price
    ...
    // ─── Subscription ref (if subscription trip) ─────
    subscriptionId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'Subscription',
      default: null,
    ...
    // ─── Rating done? ─────────────────────────────────
    isRatedByRider:  { type: Boolean, default: false },
    isRatedByDriver: { type: Boolean, default: false },
  },
  { timestamps: true }
);
