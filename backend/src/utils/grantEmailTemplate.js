const grantEmailTemplate = ({ name, amount, note }) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1f2937;">
      <h1 style="color: #ea580c;">Shakti 🛺</h1>
      <p>Hello ${name || 'there'},</p>

      <p>Good news — funds have been added to your Shakti driver wallet.</p>
      ...
      <p>This amount is now part of your withdrawable wallet balance. You can cash it out to your bank, Khalti or eSewa from the Shakti driver app.</p>

      <p>Thanks for driving with us,<br/>The Shakti Team</p>
    </div>
  `;
};
