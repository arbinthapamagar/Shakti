...
const notificationEmailTemplate = ({ name, title, body, link, linkLabel = 'View in Shakti' }) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1f2937;">
      ...
      <p style="color: #6b7280; font-size: 13px; margin-top: 24px;">You're receiving this because of activity on your Shakti account.</p>
      <p style="color: #6b7280; font-size: 13px;">— The Shakti Team</p>
    </div>
  `;
};
